...
Feature: Set passing marks for tests
  ...
  Scenario: Set MCQ passing mark
  Scenario: Set invalid MCQ passing mark
  Scenario: Set Descriptive questions passing mark
  Scenario: Set invalid Descriptive questions passing mark
